...
python3 scripts/other/visualization/visualize_heat_diffusion.py --output viz_output

# Generate 3D visualizations
echo "🎨 Generating 3D visualizations..."
python3 scripts/other/visualization/visualize_heat_3d.py --output viz_output
