...
# Parametric Strong Scaling Script
# Tests different task/cpu configurations and energy sources

echo "=========================================="
echo "Parametric Strong Scaling Tests"
echo "=========================================="
...
for config in "${CONFIGS[@]}"; do
    ...
    for energy_src in "${ENERGY_SOURCES[@]}"; do
        ...
        for nodes in 1 2 4 8 16; do
            ...
            JOB_NAME="strong_${CONFIG_DESC}_${nodes}n_${TOTAL_TASKS}t_e${energy_src}"
            ...
            sbatch --nodes=${nodes} \
                   ...
                   --time=01:00:00 \
                   --job-name=${JOB_NAME} \
                   --export=ALL,PROGRAM_ARGS="${PARAMS}",TEST_TYPE="strong",BUILD_VARIANT="ofast_omp_improved" \
...
echo ""
echo "=========================================="
echo "All parametric strong scaling jobs submitted"
