...
def plot_strong_speedup_efficiency(results, output_path_speedup, output_path_efficiency, output_path_combined):
    ...
    ax_speedup.legend(loc='best', fontsize=10, framealpha=0.9)
    ...
    ax_speedup_only.legend(loc='best', fontsize=10, framealpha=0.9)
    ...
    ax_efficiency_only.axhline(y=100.0, color='k', linestyle='--', linewidth=1.5, alpha=0.5, 
                              label='Ideal Efficiency', zorder=1)
    ...
    ax_efficiency_only.legend(loc='best', fontsize=10, framealpha=0.9)
